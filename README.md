# AppD POC Service API OpenAPI Specification
[![Build Status](https://travis-ci.org/ftbb/doc-test.svg?branch=master)](https://travis-ci.org/ftbb/doc-test)
...
6. If you did everything correct, https://ftbb.github.io/doc-test/ will lead to your new docs
...
- Documentation(ReDoc): https://ftbb.github.io/doc-test/
- SwaggerUI: https://ftbb.github.io/doc-test/swagger-ui/
- Look full spec:
    + JSON https://ftbb.github.io/doc-test/swagger.json
    + YAML https://ftbb.github.io/doc-test/swagger.yaml
- Preview spec version for branch `[branch]`: https://ftbb.github.io/doc-test/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://ftbb.github.io/doc-test/ with url from the message: `Server started <url>`
